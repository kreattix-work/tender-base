    ...
    <div class="card">
        <div class="card-body card-filter-container">
            <div class="form-group form-group-type-text flex-1">
                ...
                <input type="text" placeholder="Seacrh buyer name" class="form-control form-control-rounded form-control-sm">
            </div>
            <span>In:</span>
        ...
        <div class="card-body d-flex justify-content-between">
            <div class="card-filter-container">
                ...
                <div class="form-group">
                    ...
                    <input type="text" placeholder="Search by tender title" class="form-control form-control-rounded form-control-sm">
                </div>
            </div>
            <div class="card-filter-container">
                <button class=" btn btn-text p-0 no-hover">
                ...
                <div class="data-card box-gy-6">
                    <div class="row gx-0">
                        <div class="col box-gy-3">
                            ...
                            <div class="d-flex align-items-center box-gx-3">
                                ...
                                <div class="box-gx-1 d-flex align-items-center">
                                    <span class="text-muted font-weight-sm">Tender :</span>
                        ...
                        <div class="col-auto">
                            <div class="box-gy-2">
                                <div class="box-gx-1 d-flex align-items-center">
                                    <span class="text-muted font-weight-sm">Total Tender :</span>
                                    <span>50</span>
                                </div>
                                <div class="box-gx-1 d-flex align-items-center">
                                    <span class="text-muted font-weight-sm">Value :</span>
                                    <span>N/A</span>
                                </div>
                            </div>
                        </div>
                    ...
                    <div class="row align-items-center">
                        ...
                        <div class="col-auto d-flex box-gx-4">
                            <button class="btn btn-rounded btn-outlined-secondary">Follow</button>
                        </div>
                    </div>
                </div>
