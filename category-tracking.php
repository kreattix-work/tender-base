            ...
            <div class="row align-items-center" id="card-header-parent-id" data-collapse-status="open">
                ...
                <div class="col">
                    <div class="d-flex align-items-center justify-content-end box-gx-4">
                        ...
                        <div>
                            <button class="btn btn-rounded btn-outlined-dark px-5" data-collapse="#collapseid-1" data-collapse-status="open" data-collapse-parent="#card-header-parent-id">
