                    ...
                    <li class="sider-menu-item submenu-open">
                        ...
                        <ul class="sider-submenu">
                            ...
                            <li class="sider-submenu-item">
                                ...
                                <ul class="sider-submenu">
                                    <li class="sider-submenu-item">
                                        <div class="box-gy-2 pb-2">
                                            <div class="d-flex justify-content-between px-4">
                                                <div class="">
                                                    <div class="">My Folder <strong>(4)</strong></div>
                                                    <div class="font-sm font-weignt-sm text-muted">Create & customize
                                                        tender
                                                    </div>
                                                </div>
                                            ...
                                            <div
                                                class="d-flex justify-content-between bg-primary-light-hover transition px-4 py-1">
                                                ...
                                                <div class="hover-popover d-flex align-items-center">
                                                    <span
                                                        class="text-primary material-icons-outlined icon-sm">more_vert</span>
                                                    <div class="hover-popover-item">
                                                        <button
                                                            class="btn btn-text justify-content-start hover-popover-item-button">Rename</button>
                                                        <button
                                                            class="btn btn-text justify-content-start hover-popover-item-button">Delete</button>
                                                    </div>
                                                </div>
                                            </div>
                                            <div
                                            ...
                                            <div
                                                ...
                                                <div class="d-flex align-items-center box-gx-2">
                                                    <span class="icon-sm material-icons-outlined">folder</span>
                                                    <div>Agriculture and Farm..(<span class="text-primary">55</span>)
                                                    </div>
                                                </div>
                                                <div class="hover-popover d-flex align-items-center">
                                                    <span
