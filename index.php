...
<body>
    ...
    <div><a href="/buyer-profile.php">Buyer Profile</a></div>
    ...
    <div><a href="./supplier-profile.php">Supplier Profile</a></div>
    <div><a href="./category-tracking.php">Category Tracking</a></div>
    <div><a href="./manage-team.php">Manage Team</a></div>
    <div><a href="./add-member.php">Add Member</a></div>
    <div><a href="./manage-account-my-profile.php">Manage Account - My Profile</a></div>
    <div><a href="./manage-account-my-profile-edit.php">Manage Account - My Profile - Edit</a></div>
    <div><a href="./manage-account-my-profile-change-password.php">Manage Account - My Profile - Change Password</a></div>
    <div><a href="./manage-account-tender-alert-settings.php">Manage Account - Tender Alert Settings</a></div>
    <div><a href="./manage-account-tender-alert-preference.php">Manage Account - Tender Alert Preference</a></div>
