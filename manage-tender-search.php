...
<div class="content-body box-gy-3">
    <div class="card shadow-sm">
        <div class="card-body">
            <div class="row gy-4">
                <div class="col-md-24 col-lg card-filter-container">
                ...
                <div class="col-md-24 col-lg-auto card-filter-container ">
                    <span>In:</span>
                    <div class="col-divider"></div>
        ...
        <div class="card-body">
            <div class="row gy-4 justify-content-between">
                ...
                <div class="col-auto card-filter-container">
                    ...
                    <div class="col-divider"></div>
                    <button class="btn btn-text btn-outlined-dark p-0 no-hover sort-btn sort-status-desc">
        ...
        <div class="card-body no-border card-body-sm pt-0">
            <div class="data-card-group">
                <div class="data-card box-gy-6">
                    <div class="row gx-0">
                        <div class="col box-gy-2">
                            <div class="d-flex flex-wrap align-items-center box-gx-2 box-gy-1">
                            ...
                            <div class="d-flex flex-wrap align-items-center box-gx-3 box-gy-1">
                                ...
                                <div class="box-gx-1 d-flex align-items-center">
                                    <span class="text-muted font-weight-sm text-nowrap">Buyer :</span>
                ...
                <div class="data-card box-gy-6">
                    ...
                    <div class="row align-items-center gy-2">
                        <div class="col">
                            <div class="d-flex flex-wrap align-items-center box-gx-3 box-by-1">
                                <div class="box-gx-1 d-flex align-items-center">
                                    <span class="text-muted icon-sm material-icons-outlined">attach_file</span>
                                    <span>Attachment</span>
                                </div>
