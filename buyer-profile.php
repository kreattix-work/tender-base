...
<div class="content-body bg-white">
    <div class="d-flex align-items-center justify-content-between">
        <div class="d-flex align-items-center box-gx-3">
            <img src="/assets/images/icons/chalkboard-teacher.svg" alt="">
            <div>Department for Business, Energy & Industrial Strategy (BEIS)</div>
        </div>
        <div>
        ...
        <div id="tabs-2">
            <div class="table-responsive">
                <table class="table">
                    ...
                    <tbody>
                        <tr>
                            <td class="text-dark">Provision Of Ad Hoc Security, Dn509634</td>
                            <td class="text-dark">Awarded</td>
                            <td>860K</td>
                            <td>08/03/2021</td>
                        </tr>
                        <tr>
